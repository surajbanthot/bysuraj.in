...
export default function HireMePage() {
  ...
  return (
    <main className="min-h-[calc(100vh-56px)] bg-white px-4 pb-28 pt-8 text-sky-900 dark:bg-sky-950 dark:text-sky-50 sm:px-8 sm:pb-12 sm:pt-10">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-10">
        ...
        >
          <div className="inline-flex w-fit rounded-full border border-sky-200/70 bg-sky-50/60 p-1.5 dark:border-sky-800 dark:bg-sky-950/40">
            <button
              type="button"
              role="tab"
              ...
              className={`rounded-full px-5 py-2.5 text-lg font-medium transition sm:px-6 sm:py-3 sm:text-xl font-[family-name:var(--font-bungee)] ${activeTab === "fulltime"
                ...
                : "text-slate-600 hover:text-sky-900 hover:bg-sky-100 dark:text-sky-300 dark:hover:text-sky-50 dark:hover:bg-sky-900"
                }`}
            >
              Full time
            </button>
        ...
        <div className="text-lg text-slate-600 dark:text-sky-300 sm:text-xl font-[family-name:var(--font-quantico)]">
          {activeTab === "fulltime" ? (
            <div className="mx-auto w-full max-w-6xl space-y-20 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="flex flex-col gap-10 rounded-3xl border border-sky-200 bg-sky-50/80 p-8 backdrop-blur-sm dark:border-sky-800 dark:bg-sky-900/50 sm:p-12 shadow-sm">
                ...
                <div className="flex flex-wrap items-center justify-between gap-6">
                  <div className="flex flex-wrap items-center gap-4">
                    ...
                    <span className="text-base font-medium text-slate-600 dark:text-sky-300 flex items-center gap-2">
                ...
                <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                  <div className="space-y-3">
                    <h3 className="text-sm font-bold text-slate-500 uppercase tracking-widest dark:text-slate-400">
                      Preferred Roles
                    </h3>
                    <p className="text-2xl font-bold text-sky-900 dark:text-sky-50 leading-tight">
                  ...
                  <div className="space-y-3">
                    ...
                    <p className="text-2xl font-bold text-sky-900 dark:text-sky-50">
                      Immediate
                    </p>
                  </div>
                  ...
                  <div className="space-y-3 md:col-span-2 lg:col-span-3">
                    ...
                    <div className="flex flex-wrap gap-3">
                      {["React", "Next.js", "Node.js", "TypeScript", "Python", "Testing", "Figma", "Framer", "Rive", "After Effects", "Premiere Pro", "Illustrator", "Blender3D"].map(tag => (
                        <span key={tag} className="rounded-xl border border-sky-200 bg-white px-4 py-2 text-base font-semibold text-sky-800 shadow-sm dark:border-sky-800 dark:bg-sky-950 dark:text-sky-200">
                          {tag}
                        </span>
                      ))}
                    </div>
                ...
                <div className="space-y-16">
                  ...
                  <div className="relative flex flex-col md:flex-row md:items-center md:justify-between group">
                    ...
                    <div className="md:w-1/2 md:pl-16 pl-16 order-1 md:order-2">
                      <div className="relative rounded-3xl border border-sky-200 bg-white p-8 shadow-sm transition-all hover:shadow-md dark:border-sky-800 dark:bg-sky-900/40 text-left">
                        <span className="mb-3 block font-mono text-base font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Sep 2022 – Nov 2023</span>
                        <h3 className="text-3xl font-bold text-sky-900 dark:text-sky-50 mb-1">Mirafra Technologies</h3>
                  ...
                  <div className="relative flex flex-col md:flex-row md:items-center md:justify-between group">
                    <div className="md:w-1/2 md:pr-16 pl-16 md:pl-0 order-1">
                      <div className="relative rounded-3xl border border-sky-200 bg-white p-8 shadow-sm transition-all hover:shadow-md dark:border-sky-800 dark:bg-sky-900/40 text-left">
                        <span className="mb-3 block font-mono text-base font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Nov 2021 – Feb 2022</span>
                        <h3 className="text-3xl font-bold text-sky-900 dark:text-sky-50 mb-1">Liftoff LLC</h3>
                        <div className="mb-6 text-xl font-bold text-sky-700 dark:text-sky-300">
                  ...
                  <div className="relative flex flex-col md:flex-row md:items-center md:justify-between group">
                    ...
                    <div className="md:w-1/2 md:pl-16 pl-16 order-1 md:order-2">
                      <div className="relative rounded-3xl border border-sky-200 bg-white p-8 shadow-sm transition-all hover:shadow-md dark:border-sky-800 dark:bg-sky-900/40 text-left">
                        <span className="mb-3 block font-mono text-base font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Jun 2018 – Oct 2020</span>
                        <h3 className="text-3xl font-bold text-sky-900 dark:text-sky-50 mb-1">Broadridge Financial Solutions</h3>
                        <div className="mb-6 text-xl font-bold text-sky-700 dark:text-sky-300">
                          Front-end Developer (React.js)
                        </div>
                        <ul className="list-disc list-outside ml-5 space-y-3 text-lg text-sky-800 dark:text-sky-200 leading-relaxed font-medium">
                  ...
                  <div className="relative flex flex-col md:flex-row md:items-center md:justify-between group">
                    <div className="md:w-1/2 md:pr-16 pl-16 md:pl-0 order-1">
                      <div className="relative rounded-3xl border border-sky-200 bg-white p-8 shadow-sm transition-all hover:shadow-md dark:border-sky-800 dark:bg-sky-900/40 text-left">
                        <span className="mb-3 block font-mono text-base font-semibold text-slate-500 dark:text-slate-400 uppercase tracking-wider">Jun 2015 – May 2018</span>
                        <h3 className="text-3xl font-bold text-sky-900 dark:text-sky-50 mb-1">Ramaiah Institute of Technology</h3>
                        <div className="mb-6 text-xl font-bold text-sky-700 dark:text-sky-300">
            ...
            <div className="flex flex-col gap-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div
                  ...
                  className={`relative rounded-3xl border border-sky-200 bg-white p-8 shadow-sm transition-all hover:shadow-md dark:border-sky-800 dark:bg-sky-900/40 text-left flex flex-col gap-4 ${activeCard === "motion" && cursorPhase === "active" ? "cursor-none" : ""}`}
                >
                  ...
                  <div className="absolute top-8 right-8 flex gap-2 z-10">
                    <a href="https://contra.com/suraj_kumar_b_c_0uicot57" target="_blank" rel="noreferrer" className="rounded-full bg-sky-900 px-3 py-1.5 text-xs font-bold text-white hover:bg-sky-700 dark:bg-sky-100 dark:text-black dark:hover:bg-sky-300 shadow-sm transition-colors">Contra</a>
                    <a href="mailto:surajcommercial@gmail.com" className="group relative rounded-full bg-white border border-sky-200 px-3 py-1.5 text-xs font-bold text-sky-700 hover:bg-sky-50 dark:bg-sky-800 dark:border-sky-700 dark:text-sky-300 dark:hover:bg-sky-700 shadow-sm transition-colors">
                      Email
                      <span className="absolute right-0 top-full mt-2 hidden whitespace-nowrap rounded bg-sky-800 px-2 py-1 text-xs text-white shadow-lg group-hover:block dark:bg-sky-100 dark:text-sky-900 z-50">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-sky-900 dark:text-sky-100 pr-24">Motion Graphics Artist</h3>
                    <p className="mt-2 text-lg text-slate-600 dark:text-sky-300 font-medium leading-relaxed">
                  ...
                  <div className="mt-auto flex flex-wrap gap-2 pt-2">
                    {["Premiere Pro", "After Effects", "Illustrator", "Blender 3D"].map(tag => (
                      <span key={tag} className="rounded-lg bg-sky-100 px-3 py-1 text-sm font-semibold text-sky-700 dark:bg-sky-800 dark:text-sky-300">
                        {tag}
                      </span>
                    ))}
                  </div>
                ...
                <div
                  ...
                  onMouseLeave={handleCardMouseLeave}
                  onMouseMove={handleMouseMove}
                  className={`relative rounded-3xl border border-sky-200 bg-white p-8 shadow-sm transition-all hover:shadow-md dark:border-sky-800 dark:bg-sky-900/40 text-left flex flex-col gap-4 ${activeCard === "rive" && cursorPhase === "active" ? "cursor-none" : ""}`}
                >
                  ...
                  <div className="h-12 w-12 rounded-2xl bg-orange-100 text-sky-600 flex items-center justify-center text-2xl dark:bg-orange-900/30 dark:text-sky-400">
                    ⚡️
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold text-sky-900 dark:text-sky-100 pr-20">Rive Expert</h3>
                    <p className="mt-2 text-lg text-slate-600 dark:text-sky-300 font-medium leading-relaxed">
                ...
                <div
                  ...
                  onMouseLeave={handleCardMouseLeave}
                  onMouseMove={handleMouseMove}
                  className={`relative rounded-3xl border border-sky-200 bg-white p-8 shadow-sm transition-all hover:shadow-md dark:border-sky-800 dark:bg-sky-900/40 text-left flex flex-col gap-4 ${activeCard === "frontend" && cursorPhase === "active" ? "cursor-none" : ""}`}
                >
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-sky-900 dark:text-sky-100 pr-16">AI Engineer</h3>
                    <p className="mt-2 text-lg text-slate-600 dark:text-sky-300 font-medium leading-relaxed">
                ...
                <div
                  ...
                  onMouseLeave={handleCardMouseLeave}
                  onMouseMove={handleMouseMove}
                  className={`relative rounded-3xl border border-sky-200 bg-white p-8 shadow-sm transition-all hover:shadow-md dark:border-sky-800 dark:bg-sky-900/40 text-left flex flex-col gap-4 ${activeCard === "analogue" && cursorPhase === "active" ? "cursor-none" : ""}`}
                >
                  ...
                  <div className="h-12 w-12 rounded-2xl bg-sky-100 text-slate-600 flex items-center justify-center text-2xl dark:bg-sky-800 dark:text-slate-400">
                    📷
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold text-sky-900 dark:text-sky-100 pr-24">Analogue Photographer</h3>
                    <p className="mt-2 text-lg text-slate-600 dark:text-sky-300 font-medium leading-relaxed">
